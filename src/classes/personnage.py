...
class Personnage:
	...
	coups: dict = {
		...
		melee.enums.Action.UPSMASH: Coup(melee.enums.Button.BUTTON_C, 0.5, 1.0, melee.Position(0, 0), melee.Position(5, 10)),
		...
		melee.enums.Action.BAIR: Coup(melee.enums.Button.BUTTON_C, 0.0, 0.5, melee.Position(0, 0), melee.Position(5, 10)),
		melee.enums.Action.UAIR: Coup(melee.enums.Button.BUTTON_C, 0.5, 1.0, melee.Position(0, 0), melee.Position(5, 10)),
	...
	def effectuer_coup(self, coup: Coup):
		...
		if(coup.bouton in [melee.enums.Button.BUTTON_MAIN, melee.enums.Button.BUTTON_C]):
			print(self.controller.prev.c_stick)
